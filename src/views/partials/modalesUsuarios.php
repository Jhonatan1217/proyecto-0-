  ...
  <div class="modal-usuario-box bg-white rounded-2xl overflow-hidden">
    ...
    <form id="formUsuario" class="flex flex-col flex-1 min-h-0" novalidate>
      ...
      <div class="modal-usuario-body flex-1"><div class="modal-usuario-form-content space-y-5">
        ...
        <div><label for="tipo_documento_nuevo" class="label-enterprise">Tipo de documento</label><div class="relative"><select id="tipo_documento_nuevo" name="tipo_documento" required class="select-usuario input-enterprise pr-10 appearance-none cursor-pointer"><?= $selTipoDoc ?></select><?= $chevron ?></div></div>
        ...
        <div><label for="cargo_nuevo" class="label-enterprise">Cargo</label><div class="relative"><select id="cargo_nuevo" name="cargo" class="selectCargoModal select-usuario input-enterprise pr-10 appearance-none cursor-pointer" required><?= $selCargo ?></select><?= $chevron ?></div></div>
  ...
  <div class="modal-usuario-box bg-white rounded-2xl overflow-hidden">
    ...
    <form id="formEditarUsuario" class="flex flex-col flex-1 min-h-0" novalidate>
      ...
      <div class="modal-usuario-body flex-1"><div class="modal-usuario-form-content space-y-5">
        ...
        <div><label for="tipo_documento_editar" class="label-enterprise">Tipo de documento</label><div class="relative"><select id="tipo_documento_editar" name="tipo_documento" required class="select-usuario input-enterprise pr-10 appearance-none cursor-pointer"><?= $selTipoDoc ?></select><?= $chevron ?></div></div>
        ...
        <div><label for="cargo_editar" class="label-enterprise">Cargo</label><div class="relative"><select id="cargo_editar" name="cargo" class="selectCargoModal select-usuario input-enterprise pr-10 appearance-none cursor-pointer" required><?= $selCargo ?></select><?= $chevron ?></div></div>
