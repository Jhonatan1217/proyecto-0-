...
<head>
  ...
  /* Fix: select-styled tem padding natural ~40px; form-field forzaba 36px y cortaba el texto */
  .select-styled.form-field {
    height: auto;
  }
    ...
    <script>
      (function(){
        ...
        if (selComp && inpComp && panelComp) {
          ...
          // Reset combobox when programa changes
          if (selProgForComp) {
